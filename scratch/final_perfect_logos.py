...
def create_final_logos():
    ...
    new_data = data.copy()
    new_data[:, :, 3] = new_a
    # Make all text pixels 100% solid pure white (#ffffff)
    ...
    # Text: x=185..873, y=410..550
    icon_crop = clean.crop((165, 135, 415, 415))
    text_crop = clean.crop((185, 410, 873, 550))
    ...
    print("Final perfect logos generated successfully!")
