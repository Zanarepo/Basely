...
import { StrategyTemplateVariant } from '../constants/strategyTemplates'

interface StrategyTemplateCardProps {
  variant: StrategyTemplateVariant
...
export function StrategyTemplateCard({
  ...
  const isSelected =
    ...
    (variant.id === 'standard_product_strategy' &&
      (!currentTemplateId || currentTemplateId === 'product_strategy_document_template'))
