          ...
          return (
            <button
              ...
              className={`relative cursor-pointer w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-200 text-xs sm:text-sm font-medium ${
                isActive
                  ? 'bg-violet-50/80 dark:bg-violet-500/10 text-violet-700 dark:text-violet-300 shadow-sm border border-violet-100 dark:border-violet-500/20 font-bold before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:bg-violet-500 before:rounded-r-md'
