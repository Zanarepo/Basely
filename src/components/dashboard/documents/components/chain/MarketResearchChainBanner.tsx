        ...
        <div className="flex items-center gap-3.5 min-w-0">
          ...
          <div className="space-y-0.5 min-w-0">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300">
              Draft initial research from your Business Case, or synthesize your final research into a complete Product Strategy.
            </p>
          </div>
        </div>

        {/* Right Column: Action Dropdown */}
        <div className="shrink-0 w-full sm:w-auto flex flex-col sm:flex-row items-center gap-2">
          {isStrategyDone && (
          ...
          {isMarketResearchDone && (
            <div className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 font-semibold border border-emerald-500/30 text-xs shadow-2xs">
              <CheckCircle2 className="w-4 h-4 text-emerald-500" />
              <span>Research Drafted!</span>
            </div>
          )}
          {isCompetitiveSpecDone && (
            <div className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 font-semibold border border-emerald-500/30 text-xs shadow-2xs">
              <CheckCircle2 className="w-4 h-4 text-emerald-500" />
              <span>Spec Drafted!</span>
            </div>
          )}
          ...
          <div className="relative w-full sm:w-auto" ref={dropdownRef}>
            <button
              ...
              disabled={isSynthesizingStrategy || isDraftingMarketResearch || isDraftingCompetitiveSpec}
            ...
            >
              {isSynthesizingStrategy || isDraftingMarketResearch || isDraftingCompetitiveSpec ? (
                <>
            ...
            {isOpen && (
              <div className="absolute top-full right-0 sm:left-auto sm:right-0 mt-2 w-72 bg-app-surface border border-app-border rounded-xl shadow-xl z-50 overflow-hidden animate-fade-in-up origin-top-right">
                <div className="p-2 space-y-1">
                  <div className="px-3 py-2">
                    <span className="text-[10px] font-extrabold text-app-muted uppercase tracking-wider">Research Inputs</span>
                  </div>
                  <button
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-bold text-app-fg group-hover:text-blue-500 transition-colors">Draft Market Research</div>
                  ...
                  <div className="px-3 py-2">
                    <span className="text-[10px] font-extrabold text-app-muted uppercase tracking-wider">Research Outputs</span>
                  </div>
                  <button
