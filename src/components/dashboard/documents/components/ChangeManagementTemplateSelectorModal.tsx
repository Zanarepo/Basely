...
import { CHANGE_MANAGEMENT_TEMPLATE_VARIANTS } from '@/lib/documents/change-management-templates'

interface ChangeManagementTemplateSelectorModalProps {
  isOpen: boolean
...
export function ChangeManagementTemplateSelectorModal({
  isOpen,
  currentTemplateId,
  onClose,
  onSelectTemplate,
}: ChangeManagementTemplateSelectorModalProps) {
  const [selectedCategory, setSelectedCategory] = useState<string>('all')

  if (!isOpen) return null

  const variants = Object.values(CHANGE_MANAGEMENT_TEMPLATE_VARIANTS)
      ...
      <div className="relative w-full max-w-5xl max-h-[90vh] bg-app-surface border border-app-border rounded-3xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-black text-app-fg tracking-tight">Change Management Templates</h2>
              ...
              <p className="text-xs text-app-muted mt-0.5">
                Select a Change Management Plan format tailored to your methodology and organizational needs.
              </p>
            </div>
          </div>
        ...
        <div className="px-6 py-3 border-b border-app-border bg-app-bg/50 flex items-center gap-2 overflow-x-auto">
          {[
            ...
            { id: 'enterprise', label: 'ITIL / Enterprise' },
