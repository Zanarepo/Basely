...
import { HANDOVER_TEMPLATE_VARIANTS } from '@/lib/documents/handover-templates'

interface HandoverTemplateSelectorModalProps {
  isOpen: boolean
...
export function HandoverTemplateSelectorModal({
  isOpen,
  currentTemplateId,
  onClose,
  onSelectTemplate,
}: HandoverTemplateSelectorModalProps) {
  const [selectedCategory, setSelectedCategory] = useState<string>('all')

  if (!isOpen) return null

  const variants = Object.values(HANDOVER_TEMPLATE_VARIANTS)
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-black text-app-fg tracking-tight">Handover Templates</h2>
              ...
              <p className="text-xs text-app-muted mt-0.5">
                Select a Operational Handover format tailored to your methodology and organizational needs.
              </p>
            </div>
          </div>
