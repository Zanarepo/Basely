    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3">
        <div className="p-2.5 rounded-xl bg-violet-500/15">
          <UserPlus className="h-5 w-5 text-violet-500 dark:text-violet-400" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-2 gap-2 rounded-2xl bg-app-muted-surface border border-app-border p-1">
        <button
          ...
          className={`flex items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold transition-all cursor-pointer disabled:opacity-50 ${
            mode === 'link'
              ? 'bg-violet-500/20 text-violet-600 dark:text-violet-300 border border-violet-500/25 shadow-sm'
      ...
      {mode === 'email' && (
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-app-bg border border-app-border rounded-xl text-sm text-app-fg focus:outline-none focus:ring-2 focus:ring-violet-500 disabled:opacity-60"
          />
        </div>
      )}
      ...
      <button
        ...
        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold rounded-xl disabled:opacity-50 transition-colors shadow-sm cursor-pointer"
      >
        {isPending ? (
          <>
