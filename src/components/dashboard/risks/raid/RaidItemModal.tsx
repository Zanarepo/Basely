...
import { X, Save, ShieldAlert, Link2, Calendar, User, GitBranch, Loader2, Search, Check, Folder, Layers } from 'lucide-react'
import EnterpriseSelect from '@/components/common/EnterpriseSelect'
import { type RaidLogEntry, type RaidCategory, type RaidStatus, type RaidPriority } from '@/lib/raid/actions'
import { getTerminology } from '@/utils/terminology'
import { useRaidItemModal } from './hooks/useRaidItemModal'
...
export default function RaidItemModal({
  ...
  const {
    ...
    isOpen, onClose, projectId, organizationId, initialCategory, initialData, onSuccess, onShowToast
  )
