          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-app-bg border border-app-border rounded-xl flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-violet-500 hover:bg-violet-600 active:scale-95 text-white text-xs font-bold transition-all flex items-center gap-1 shrink-0 cursor-pointer"
              >
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-app-bg border border-app-border rounded-xl pl-10 pr-4 py-2.5 text-xs sm:text-sm text-app-fg placeholder-app-muted focus:outline-none focus:border-violet-500"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2.5 pt-2">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-2.5 rounded-xl bg-violet-500 hover:bg-violet-600 active:scale-95 text-white text-xs sm:text-sm font-bold shadow-md shadow-violet-500/20 transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
              >
