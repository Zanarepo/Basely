...
export const metadata = {
  ...
  description: 'Privacy Policy and Google API Data Usage for Baseline',
}
      ...
      <div className="max-w-3xl mx-auto bg-app-surface border border-app-border rounded-2xl shadow-sm p-8 sm:p-12">
        ...
        <div className="space-y-8 text-app-subtle">
          <section>
            ...
            <p>
              Welcome to Baseline. We respect your privacy and are committed to protecting your personal data. 
              This privacy policy explains how we collect, use, store, and share your data when you use the Baseline platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Baseline integrates with Google Services to enhance your project management experience. We specifically request access to your Google Calendar and Google Drive.
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>
                <strong>Google Calendar:</strong> We access your Calendar to sync Baseline project tasks directly to your phone and calendar apps. This enables you to receive fast notifications, deadlines, and reminders exactly where you need them.
              </li>
              <li>
                <strong>Google Drive:</strong> We access your Drive to allow you to easily browse, attach, and access your project files and documents directly within the Baseline platform, keeping your workflow unified.
              </li>
            </ul>
          ...
          <section>
            ...
            <p>
              <strong>We do not sell your personal data or Google user data to any third parties.</strong> Data retrieved from Google APIs is used strictly to provide the calendar syncing and file attachment features within the Baseline platform. We do not use your Google data for serving advertisements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              You can also revoke Baseline's access to your Google account at any time via your Google Account Security settings.
            </p>
          </section>
