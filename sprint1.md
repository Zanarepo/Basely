...
[x] Task 1.1: Design Core Tables Script
...
[x] Task 1.2: Establish Automated Profile Sync Trigger
...
[x] Task 1.4: Define Custom PostgreSQL Database Functions (RPC)
...
[x] Task 2.1: Initialize Supabase Client Packages
...
[x] Task 2.2: Build Core Auth Screens
...
[x] Task 2.3: Configure Global Next.js Middleware Route Protection
...
[x] Task 3.1: Build Workspace Interceptor Route
...
[x] Task 3.2: Build "Create Organization" Component UI
...
[x] Task 3.3: Implement Workspace Switcher Component
...
[x] Task 3.4: Create Link-Invite Database Logic
...
[x] Task 3.5: Build "Invite Team" Dialog UI
...
[x] Task 3.6: Build the Invite Landing Page Overwrite (/invite?token=...)
...
[x] Task 3.7: Set up Email Infrastructure (Resend / SendGrid)
...
[x] Task 3.8: Create the Targeted Email Invite Form
...
[x] Task 3.9: Deploy a Supabase Edge Function (send-email-invite)
...
[x] Task 3.10: Tighten Security Checks for Email Invites
...
[x] Task 4.1: Build Multistep Project Setup Form UI
...
[x] Task 4.2: Frontend Validation and Submission Integration
...
[x] Task 4.3: Build Project Dashboard Entry View
