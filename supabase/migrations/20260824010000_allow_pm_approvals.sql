-- Drop old policies
drop policy if exists "Users can view their own requests and admins can view all org requests" on public.approval_requests;
drop policy if exists "Admins can update requests to approve/reject" on public.approval_requests;

-- Recreate with PM included
create policy "Users can view their own requests and admins/PMs can view all org requests"
...
create policy "Admins and PMs can update requests to approve/reject"
